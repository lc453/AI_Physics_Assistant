...
It also has the ability to derive keywords from prompts and search them in arxiv.org, summarizing the top results and keeping them in the context to use in answering physics-related questions.
